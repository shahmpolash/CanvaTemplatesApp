...
const Footer = () => {
  ...
  useEffect(() => {
    fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/logo`)
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/categories`)
      .then((res) => res.json())
      .then((info) => setCategories(info));
  }, [categories]);

  useEffect(() => {
    fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/footer-about`)
      .then((res) => res.json())
      .then((info) => setFooterAbout(info));
  }, []);

  useEffect(() => {
    fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/footer-address`)
      .then((res) => res.json())
      .then((info) => setFooterAddress(info));
  }, [footerAddress]);

  useEffect(() => {
    fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/footer-social`)
      .then((res) => res.json())
      .then((info) => setFooterSocial(info));
  }, []);

  useEffect(() => {
    fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/copyrights`)
      .then((res) => res.json())
