...
const HomeSectionThree = () => {
  ...
  useEffect(() => {
    fetch("https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/products")
      .then((res) => res.json())
      .then((info) => setProducts(info));
  }, []);

  useEffect(() => {
    fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/sections-three/`)
      .then((res) => res.json())
