...
const PlaceOrder = () => {
  ...
  useEffect(() => {
    fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/cash-on-delivery`)
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/payment-accounts`)
      .then((res) => res.json())
  ...
  const handlePlaceOrder = (event) => {
    ...
    const url = `https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/new-order`;
    fetch(url, {
      method: "POST",
      headers: {
  ...
  const handlePlaceOrderCashOnDelivery = (event) => {
    ...
    const url = `https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/new-order-cash-on-delivery`;
    fetch(url, {
      method: "POST",
      headers: {
        "content-type": "application/json",
