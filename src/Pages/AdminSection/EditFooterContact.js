...
const EditFooterContact = () => {
    ...
    useEffect(() => {
        fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/footer-address/${id}`)
            .then((res) => res.json())
    ...
    const handlefooterAddress = (event) => {
        ...
        const url = `https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/footer-address/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
