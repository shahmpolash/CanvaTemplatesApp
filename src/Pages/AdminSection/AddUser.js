...
const AddUser = () => {
    ...
    useEffect(() => {
        fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/users`)
            .then((res) => res.json())
    ...
    const handleUser = (event) => {
        ...
        const url = `https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/add-user`;
        fetch(url, {
            method: "POST",
            headers: {
    ...
    useEffect(() => {
        const fetchAdminUsers = async () => {
            try {
                const response = await fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/users`);
