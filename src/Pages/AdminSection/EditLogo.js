...
const EditLogo = () => {
    ...
    useEffect(() => {
        fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/logo/${id}`)
            .then((res) => res.json())
    ...
    const handleLogo = (event) => {
        ...
        const url = `https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/logo/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
