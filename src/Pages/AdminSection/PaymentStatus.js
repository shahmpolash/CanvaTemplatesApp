...
const PaymentStatus = () => {
    ...
    useEffect(() => {
        fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/order/${id}`)
            .then((res) => res.json())
    ...
    const handlePaymentStatus = (event) => {
        ...
        const url = `https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/order/${order._id}`;
        fetch(url, {
            method: "PUT",
            headers: {
    ...
    const handleOrderStatus = (event) => {
        ...
        const url = `https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/order-for-status/${order._id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                "content-type": "application/json",
