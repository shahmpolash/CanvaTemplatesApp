...
const EditTestimonial = () => {
    ...
    useEffect(() => {
        fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/testimonial/${id}`)
            .then((res) => res.json())
    ...
    const handleTestimonialSection = (event) => {
        ...
        const url = `https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/testimonial/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
