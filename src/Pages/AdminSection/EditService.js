...
const EditService = () => {
    ...
    useEffect(() => {
        fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/service-item/${id}`)
            .then((res) => res.json())
    ...
    const handleAddItem = (event) => {
        ...
        const url = `https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/service-item/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
