...
const ViewMessage = () => {
    ...
    useEffect(() => {
        fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/message/${id}`)
            .then((res) => res.json())
    ...
    const handleMessage = (event) => {
        ...
        const url = `https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/message/${message._id}`;
        fetch(url, {
            method: "PUT",
            headers: {
