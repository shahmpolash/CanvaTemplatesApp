...
const UpdateUser = () => {
    ...
    useEffect(() => {
        fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/users/${id}`)
            .then((res) => res.json())
    ...
    const handleUser = (event) => {
        ...
        const url = `https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/upadete-users/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
