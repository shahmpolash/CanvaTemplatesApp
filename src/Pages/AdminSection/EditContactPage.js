...
const EditContactPage = () => {
    ...
    useEffect(() => {
        fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/contacts/${id}`)
            .then((res) => res.json())
    ...
    const handleContactSection = (event) => {
        ...
        const url = `https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/contacts/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
