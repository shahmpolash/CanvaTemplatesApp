...
const VideoSection = () => {
    ...
    useEffect(() => {
        fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/video`)
            .then((res) => res.json())
    ...
    const handleVideoSection = (event) => {
        ...
        const url = `https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/add-video`;
        fetch(url, {
            method: "POST",
            headers: {
