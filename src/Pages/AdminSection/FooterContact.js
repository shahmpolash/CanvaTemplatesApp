...
const FooterContact = () => {
    ...
    const handlefooterAddress = (event) => {
        ...
        const url = `https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/add-footer-address`;
        fetch(url, {
            method: "POST",
            headers: {
                                ...
                                <>
                                    {
                                        footeraddress.map(c =>
                                            footeraddress.map(c =>
                                                <Link className='btn' to={`/edit-address-footer/${c._id}`}> Please Edit Address Footer</Link>)
