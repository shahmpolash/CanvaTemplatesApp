...
const ContactPage = () => {
    ...
    useEffect(() => {
        fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/contacts`)
            .then((res) => res.json())
    ...
    const handleContactSection = (event) => {
        ...
        const url = `https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/add-contact`;
        fetch(url, {
            method: "POST",
            headers: {
