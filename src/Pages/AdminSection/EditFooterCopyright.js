...
const EditFooterCopyright = () => {
    ...
    useEffect(() => {
        fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/copyrights/${id}`)
            .then((res) => res.json())
    ...
    const handleFooterCopyright = (event) => {
        ...
        const url = `https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/copyrights/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
