...
const AboutSection = () => {
    ...
    useEffect(() => {
        fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/about`)
            .then((res) => res.json())
    ...
    const handleAboutSection = (event) => {
        ...
        const url = `https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/add-about`;
        fetch(url, {
            method: "POST",
            headers: {
