...
const ServicesSection = () => {
    ...
    useEffect(() => {
        fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/service`)
            .then((res) => res.json())
            .then((info) => setService(info));
    }, []);

    useEffect(() => {
        fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/service-items`)
            .then((res) => res.json())
    ...
    const handleServiceSection = (event) => {
        ...
        const url = `https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/add-Service`;
        fetch(url, {
            method: "POST",
            headers: {
    ...
    const handleAddItem = (event) => {
        ...
        const url = `https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/add-service-item`;
        fetch(url, {
            method: "POST",
            headers: {
                "content-type": "application/json",
