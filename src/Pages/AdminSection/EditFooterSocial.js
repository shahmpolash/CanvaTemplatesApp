...
const EditFooterSocial = () => {
    ...
    useEffect(() => {
        fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/footer-social/${id}`)
            .then((res) => res.json())
    ...
    const handleFootersocial = (event) => {
        ...
        const url = `https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/footer-social/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
