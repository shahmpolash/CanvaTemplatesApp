...
const EditFooterabout = () => {
    ...
    useEffect(() => {
        fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/footer-about/${id}`)
            .then((res) => res.json())
    ...
    const handleFooterAbout = (event) => {
        ...
        const url = `https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/footer-about/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
