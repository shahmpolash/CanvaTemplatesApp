...
const EditServicestext = () => {
    ...
    useEffect(() => {
        fetch(`https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/service/${id}`)
            .then((res) => res.json())
    ...
    const handleServiceText = (event) => {
        ...
        const url = `https://canva-templates-fiest-project-60ed7bdc5f20.herokuapp.com/service/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
